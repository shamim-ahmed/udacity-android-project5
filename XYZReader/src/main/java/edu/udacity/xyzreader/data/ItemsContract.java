package edu.udacity.xyzreader.data;

import android.net.Uri;

public class ItemsContract {
	public static final String CONTENT_AUTHORITY = "edu.udacity.xyzreader";
	public static final Uri BASE_URI = Uri.parse("content://edu.udacity.xyzreader");
	...
	public static class Items implements ItemsColumns {
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.edu.udacity.xyzreader.items";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.edu.udacity.xyzreader.items";
